...
export interface IBaseRepository<T> {
  // Protected methods that extending classes should implement
  _create(
    data: Partial<T>,
    performedBy: string,
    entityName: string,
  ...
  _buildPaginatedResult(data: T[], total: number, pagination: PaginationDto): PaginatedResult<T>;

  // Generic field-based search methods
  _findByField(
