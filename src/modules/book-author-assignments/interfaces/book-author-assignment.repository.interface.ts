...
export interface IBookAuthorAssignmentRepository {
  createAssignment(createBookAuthorAssignmentDto: CreateBookAuthorAssignmentDto, performedBy?: string): Promise<BookAuthorAssignment>;
  getAssignmentProfile(assignmentId: string): Promise<BookAuthorAssignment>;
  updateAssignment(assignmentId: string, updateBookAuthorAssignmentDto: UpdateBookAuthorAssignmentDto, performedBy?: string): Promise<BookAuthorAssignment>;
  deactivateAssignment(assignmentId: string, performedBy?: string): Promise<void>;
