...
export function ApiFilterAssignmentsRealtime() {
  return applyDecorators(
    ApiBearerAuth('JWT-auth'),
    ApiOperation({
      summary: 'Filtrar asignaciones libro-autor en tiempo real - Acceso: ADMIN, USER',
      description:
        'Búsqueda optimizada para filtrado en tiempo real de asignaciones libro-autor con debounce. Mínimo 3 caracteres.',
    }),
    ApiQuery({
      name: 'term',
      description: 'Término de búsqueda para filtrar asignaciones (mínimo 3 caracteres)',
      required: true,
      type: String,
      example: 'garcia',
    }),
    ...
    ApiResponse({
      status: 200,
      description: 'Lista paginada de asignaciones libro-autor filtradas',
