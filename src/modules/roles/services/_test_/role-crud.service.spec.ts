...
describe("RoleCrudService", () => {
  ...
  describe("create", () => {
    ...
    it("should handle validation errors during creation", async () => {
      ...
      expect(errorHandler.handleError).toHaveBeenCalledWith(validationError, ERROR_MESSAGES.ROLES?.FAILED_TO_CREATE || "Failed to create role");
    });
    ...
    it("should handle repository errors during creation", async () => {
      ...
      expect(errorHandler.handleError).toHaveBeenCalledWith(repositoryError, ERROR_MESSAGES.ROLES?.FAILED_TO_CREATE || "Failed to create role");
    });
  ...
  describe("findAll", () => {
    ...
    it("should handle repository errors during findAll", async () => {
      ...
      expect(errorHandler.handleError).toHaveBeenCalledWith(error, ERROR_MESSAGES.ROLES?.FAILED_TO_GET_ALL || "Failed to retrieve roles");
    });
  });
  ...
  describe("findOne", () => {
    ...
    it("should handle repository errors during findOne", async () => {
      ...
      expect(errorHandler.handleError).toHaveBeenCalledWith(error, ERROR_MESSAGES.ROLES?.FAILED_TO_GET_ALL || "Failed to retrieve role");
    });
  });
  ...
  describe("update", () => {
    ...
    it("should handle validation errors during update", async () => {
      ...
      expect(errorHandler.handleError).toHaveBeenCalledWith(validationError, ERROR_MESSAGES.ROLES?.FAILED_TO_UPDATE || "Failed to update role");
    });
  ...
  describe("remove", () => {
    ...
    it("should handle repository errors during removal", async () => {
      ...
      expect(errorHandler.handleError).toHaveBeenCalledWith(error, ERROR_MESSAGES.ROLES?.FAILED_TO_DELETE || "Failed to delete role");
    });
