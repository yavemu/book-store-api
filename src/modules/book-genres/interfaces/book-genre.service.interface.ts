...
export interface IBookGenreService {
  ...
  findAll(pagination: PaginationDto): Promise<PaginatedResult<PaginatedResult<BookGenre>>>;
  ...
  softDelete(id: string, performedBy: string): Promise<PaginatedResult<{ id: string }>>;
  search(
    searchTerm: string,
